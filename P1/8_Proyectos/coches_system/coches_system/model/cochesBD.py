...
class Camionetas:
    ...
    @staticmethod
    def insertar(marca,color,modelo,velocidad,caballaje,plazas,traccion,cerrada):  # QUITAR 'self'
        try:
           cursor.execute(
    ...
    def consultar():
        try:
            ...
            return []
    @staticmethod
    def actualizar(marca,color,modelo,velocidad,caballaje,plazas,traccion,cerrada):
        try:
            cursor.execute("" \
...
class Camiones:
    ...
    @staticmethod
    def insertar(marca,color,modelo,velocidad,caballaje,plazas,eje,capacidadCarga):  # QUITAR 'self'
        try:
           cursor.execute(
    ...
    def consultar():
        try:
            ...
            return []
    @staticmethod
    def actualizar(marca,color,modelo,velocidad,caballaje,plazas,eje,capacidadCarga):
        try:
            cursor.execute("" \
